...
class ComponenteCurricularController extends ApiCoreController
{
    ...
    public function getComponentesCurricularesPorSerie()
    {
        if ($this->canGetComponentesCurriculares()) {
            ...
            $sql = 'SELECT componente_curricular.id, componente_curricular.nome, carga_horaria, tipo_nota, array_to_json(componente_curricular_ano_escolar.anos_letivos) anos_letivos, area_conhecimento_id, area_conhecimento.nome AS nome_area
                FROM modules.componente_curricular
